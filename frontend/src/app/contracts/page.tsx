      ...
      <div className="flex justify-between items-end animate-in fade-in slide-in-from-top-4 duration-500">
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-primary font-black text-[10px] uppercase tracking-[0.3em] mb-1">
            ...
            디지털 원장 액세스 (Digital Ledger Access)
          </div>
          <h1 className="text-4xl font-headline font-black text-on-surface tracking-tight">계약 보관함 (Contract Vault)</h1>
          <p className="text-zinc-500 max-w-lg text-sm font-medium leading-relaxed">
            AI 리스크 평가 및 테넌트 격리가 통합된 문서 관리 시스템입니다.
          </p>
        </div>
        ...
        <div className="flex items-center justify-between px-2">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold text-zinc-600 uppercase tracking-tighter">AI 분석 준비 완료</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="h-1 w-1 rounded-full bg-emerald-500 animate-pulse"></div>
              <span className="text-[10px] font-bold text-zinc-600 uppercase tracking-tighter">보안 프로토콜: 활성화됨</span>
            </div>
          </div>
        </div>
